    ...
    return (
      <div>
        ...
        <Field
          name="descisionDate"
          type="text"
          label="सम्बन्ध विछेद ठहर गर्ने अदालतको नाम र निर्णय मिति"
          component={renderField}
        />
        {/* Behula */}
        <BoxDiv>
          ...
          <Field
            ...
            type="text"
            label="नागरिकता लियेको भये, जारि मिति र जिल्ला "
            component={renderField}
          />
        </BoxDiv>
        <BoxDiv>
          ...
          <Field
            name="brideGrandDad"
            type="text"
            label="पत्नीको बाजेको नाम"
            component={renderField}
          />
          <Field
            name="brideDad"
            type="text"
            label="पत्नीको बाबुको नाम"
            component={renderField}
          />
          <Field
...
const mapStateToProps = (state) => (
  {
    initialValues: state.divorce.currentChoice
  }
);
