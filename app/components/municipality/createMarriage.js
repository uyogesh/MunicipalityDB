...
import General from '../modules/generalMarriage';
import Buttons from '../modules/Button';
import { addMarriage } from '../../actionsnew/marriage';
...
//   return error;
// };
class CreateMarriage extends React.Component {
  static propTypes={
  ...
  handleSelect() {
    ...
    addMarriage(this.state.formData, this.props.history);
  }
