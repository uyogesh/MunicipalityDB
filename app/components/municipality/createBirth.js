...
import General from '../modules/generalBirth';
import Buttons from '../modules/Button';
import { addBirth } from '../../actionsnew/birth';
...
class CreateBirth extends React.Component {
  static propTypes={
  ...
  handleSelect() {
    ...
    addBirth(this.state.formData, this.props.history);
  }
